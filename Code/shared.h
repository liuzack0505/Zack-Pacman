...
extern ALLEGRO_SAMPLE* DEAD_SOUND_EFFECT;
extern ALLEGRO_SAMPLE* HIDE_SCENE_SOUND_EFFECT;
extern ALLEGRO_FONT* menuFont_small;
extern ALLEGRO_FONT* menuFont;
extern ALLEGRO_FONT* menuFont_big;
